...
var CMake = (function (_super) {
    ...
    function CMake(environment, options) {
        var _this = _super.call(this, environment, options) || this;
        _this.name = 'cmake';
    ...
    CMake.prototype.configureCommand = function () {
        var defines = this.options.configure.flags || {};
    ...
    CMake.prototype.generate = function () {
        var _this = this;
        var header = function () {
            var pv = _this.options.cmake ? _this.options.cmake.version : '0.0.1';
            if (tmake_core_1.startsWith(pv, 'v')) {
                pv = pv.slice(1);
            }
            var version = _this.options.cmake ? _this.options.cmake.minimumVersion : '3.2';
            return "\n# generated by trieMake\ncmake_minimum_required(VERSION " + version + ")\nproject(" + _this.environment.project.name + " VERSION " + pv + ")";
        };
        var includeDirectories = function () {
            switch (_this.environment.outputType) {
                case 'static':
                case 'dynamic':
                case 'executable':
                default:
        ...
        var target = function () {
            switch (_this.environment.outputType) {
                case 'static':
                default:
                    return "\nadd_library(" + _this.environment.project.name + " STATIC ${SOURCE_FILES})";
                case 'executable':
                    return "\nadd_executable(" + _this.environment.project.name + " ${SOURCE_FILES})";
            }
        };
        var link = function () {
