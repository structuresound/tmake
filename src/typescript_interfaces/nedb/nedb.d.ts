...
declare module "nedb" {
  class NeDBDataStore {
     ...
     */
    ensureIndex(options: NeDB.EnsureIndexOptions,
     ...
     */
    find<T>(query: any, projection: T,
            callback: (err: Error, documents: Array<T>) => void): void;
     ...
     * @param {any} projection MongoDB-style projection
     */
    findOne<T>(query: any, projection: T,
               callback: (err: Error, document: T) => void): void;
     ...
     * @param {Function} cb Optional callback, signature: err,
     *                                                    numReplaced,
     *                                                    upsert (set to true if
     *the update was in fact an upsert)
     *
     * @api private Use Datastore.update which has the same signature
     */
    update(query: any, updateQuery: any, options?: NeDB.UpdateOptions,
           cb?: (err: Error, numberOfUpdated: number,
                 upsert: boolean) => void): void;
    /**
    ...
    * @param {Function} cb Optional callback, signature: err,
    *                                                    numAffected,
    *                                                    affectedDocuments (when
    *returnUpdatedDocs is set to true), obj or array
    *                                                    upsert (set to true if
    *the update was in fact an upsert)
    *
    * @api private Use Datastore.update which has the same signature
    */
    update<T>(query: any, updateQuery: any, options?: NeDB.UpdateOptions,
              cb?: (err: Error, numberOfUpdated: number, affectedDocuments: any,
                    upsert: boolean) => void): void;
    ...
    remove(query: any, options: NeDB.RemoveOptions,
           cb?: (err: Error, n: number) => void): void;
