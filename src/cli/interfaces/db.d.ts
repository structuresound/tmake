declare class DataStore<T> {
     ...
     */
    addToIndexes(doc: T): void;
    addToIndexes(doc: Array<T>): void;

    /**
     * Remove one or several document(s) from all indexes
     */
    removeFromIndexes(doc: T): void;
    removeFromIndexes(doc: Array<T>): void;
     ...
     */
    find(query: any, projection: any): PromiseLike<Array<T>>;
    find(query: any, projection: any): NeDBPromise.Cursor<T>;
     ...
     * * @param {any} query MongoDB-style query
     */
    find(query: any): PromiseLike<Array<T>>;
    find(query: any): NeDBPromise.Cursor<T>;
     ...
     * @param {any} projection MongoDB-style projection
     */
    findOne(query: any, projection: any): PromiseLike<T>;

    /**
     * Find one document matching the query
     * @param {any} query MongoDB-style query
     */
    findOne(query: any): PromiseLike<T>;
